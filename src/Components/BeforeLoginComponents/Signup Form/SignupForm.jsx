...
export default function SignupForm() {
  ...
  const getEmail = ({ target }) => {
    const newUser = { ...user, email: target.value }; // ✅ on clone le state
    setEmailErorr(
      target.value === ""
        ? t("Email required")
        : !target.value.match(
    ...
    dispatch(signUpAction(newUser)); // ✅ on envoie un nouvel objet
  };
      ...
      <div className="shadow-sm p-3 mb-5 bg-white rounded mx-auto mt-5 w-100 border">
        ...
        <div className="google-btn gap-2 mx-auto mt-3 rounded hitbtn-class">
          ...
          <div className="text-justify ">
            <p className="text-center text-white" style={{ paddingTop: ".3em" }}>
        ...
        <div className="mb-5 d-grid gap-2 col-8 mx-auto mt-3 border border-dark rounded">
          <button className="btn bg-light " type="button">
            <img src={apple} className="apple-icon" /> {t("Continue with Apple")}
          </button>
        </div>
        ...
        <form>
          <div className="form-group col-8 mx-auto mt-3">
            ...
            <input
              ...
              value={user.email || ""} // ✅ contrôlé par Redux
              onInput={getEmail}
            />
          </div>
