...
export const updateUserData = (collectionName, newData) => {
  updateDoc(doc(db, collectionName, auth.currentUser.uid), newData)
...
export const updateJob = (newData, docID) => {
  updateDoc(doc(db, "job", docID), newData)
...
export const subCollection = (
  ...
  addDoc(collection(db, collectionName, docId, subCollectionName), data)
...
export const deletesubCollection = (
  ...
  deleteDoc(doc(db, collectionName, docId, subCollectionName, docIds))
